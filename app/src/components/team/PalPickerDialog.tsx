...
interface PalPickerDialogProps {
  isOpen: boolean;
  onSelect: (palId: string) => void;
  onClose: () => void;
}

export function PalPickerDialog({ isOpen, onSelect, onClose }: PalPickerDialogProps) {
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 4, maxHeight: '45vh' }}
            >
              {filtered.map((pal) => (
                <button
                  key={pal.id}
